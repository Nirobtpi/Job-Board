...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('admin.dashboard') }}" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">JobBoard</span>
            </a>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            ...
                            <span>{{ ucwords(Auth::user()->is_admin) }}</span>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('admin.category_list') }}">
                            <i class="bi bi-circle"></i><span>Show All Category</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.category') }}">
                            <i class="bi bi-circle"></i><span>Create Catgory</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Job</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('admin.job_list') }}">
                            <i class="bi bi-circle"></i><span>Show All Job</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.create_job') }}">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            © Copyright <strong><span>Job Boad</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            Designed by <a href="">Nirob</a>
        </div>
    </footer><!-- End Footer -->
